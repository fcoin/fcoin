...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FX");
    case mBTC: return QString("mFX");
    case uBTC: return QString::fromUtf8("μFX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("FCoins"));
    case mBTC: return QString(QObject::tr("Milli-FCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-FCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}

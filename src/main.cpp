...
unsigned int nStakeMinAge = 5 * 24 * nOneHour; // 5 days as zero time weight
...
const string strMessageMagic = "FCoin Signed Message:\n";
...
{
    int64_t nSubsidy = 1400 * COIN;
	
	if (nHeight == 1)
		return 147600000 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in FCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // FCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "FCoin Genesis";
        CTransaction txNew;
        txNew.nTime = 1472829060;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1472829070;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2143407; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xc4, 0xf4, 0xe3, 0xe5 };
